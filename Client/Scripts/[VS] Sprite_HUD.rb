...
module HUD_Config
  ...
  # Movimento — v2.2.0
  # false = HUD e EXP bar fixas (jogador não pode mover)
  # true  = jogador pode arrastar livremente pela tela
  DRAGGABLE = false
...
class Sprite_HUD < Sprite2
  ...
  #---dragable: v2.2.0 — HUD fixa; respeita a flag DRAGGABLE do HUD_Config---#
  def dragable
    # Só executa o drag da superclasse se DRAGGABLE estiver habilitado.
    # Com DRAGGABLE = false (padrão), o jogador não pode mover a HUD.
    super if DRAGGABLE
  end
  ...
  def create_exp_bar
    ...
    # v2.2.0: drag da EXP bar vinculado à mesma flag DRAGGABLE
