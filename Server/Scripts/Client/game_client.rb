...
def hp=(value)
  @player_service.set_hp(self, value)
end
...
def change_equip(slot_id, item_id)
  @equipment_service.change_equip(self, slot_id, item_id)
end
...
def gain_exp(exp)
  @player_service.gain_exp(self, exp)
end
...
def gain_gold(amount, shop_sound = false, popup = false)
  @player_service.gain_gold(self, amount)
end
...
def gain_item(item, amount, drop_sound = false, popup = false)
  @inventory_service.gain_item(self, item, amount)
end

def lose_item(item, amount)
  @inventory_service.lose_item(self, item, amount)
end
